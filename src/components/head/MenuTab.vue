...
<template>
    <div id="menu-tab">
      ...
      <Input class="search-bar" size="small" search placeholder="Search here..."/>
    </div>
</template>
<script>
export default {
  ...
  data(){
      return{
          MenuList:[{name:"首页",imageURL:"ios-home",path:"/",id:"tab-1",background:"background: linear-gradient(90deg,#d6f3ffc7,#ffe1f7c7)"},
